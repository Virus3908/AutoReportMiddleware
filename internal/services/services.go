...
func getAPIResponse[T responseAudioFileSegments | responseStatus | responseInfo | responseMessage](ctx context.Context, a *http.Client, method, url string, body io.Reader) (*T, error) {
